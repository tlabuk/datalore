...
- [Set up infrastructure & choosing an installation method](#set-up-infrastructure--choose-an-installation-method-)

- [Install datalore](#install-datalore)

- [Required and optional configuration procedures](#configure-datalore)

- [Upgrade Datalore](#upgrade-datalore)
...
- [Kubernetes-based installation](/https://www.jetbrains.com/help/datalore/install-datalore-on-premises-using-kubernetes-helm.html)
