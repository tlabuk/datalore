...
In this documnt you can find my feedback on the current state of the documentation and a list of proposed changes, so you can easily pinpoint them in each solution document.
...
:::note
You'll notice that I've completely overhauled the documentation for **on-premises installation** and **managing users**.
...
You can also check the relevant chagelog sections in this document for the recap of changes for each documentation set.
:::
