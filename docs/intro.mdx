...
The original instructions assumed a high level of familiarity with Docker, I added basic steps—such as the exact command for composing the YAML file. I also fixed the references to objects in the `docker-compose.yaml` file, inserted screenshots for steps like the allowlist configuration, and included instructions for testing the deployment locally.
