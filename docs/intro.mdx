...
To improve clarity, I **reformatted step-by-step procedures into ordered lists** all over the document (following tech writing standards). I also **refined procedural phrasing**, replacing **"to finish the procedure"** with simply "Click the create button". Additionally, I added an **admonition** to highlight that **converting a Viewer to a User is irreversible**.
