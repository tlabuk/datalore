...
As an administrator, you can manage users through the **Admin panel**. To access the panel, click your avatar icon in the top-right corner of the interface and select **Admin panel** from the dropdown menu. From there, you can view, add, edit, and remove users, or manage their roles and permissions.
...
When you create a user with **viewer** type, you'll see that the dropdown with roles is greyed out:

<Zoom src="/datalore/img/manage-users/manage-users-2.png" alt="Viewer role dropdown" width="50%" />
:::

Check the [section below](#managing-and-sharing-resources-with-viewers-) to see how you can manage and share Datalore resources for **viewers**.
...
:::caution changing can't be undone
Changing type from viewer to user is irreversible.

If you want to downgrade a specific user to viewer, you'll need to delete their account and add them again as a new user with a **Viewer** type.
:::
...
1. Find the user in your Admin panel's [user list](#view-users) and open their profile.

2. Go to the **Computations tab**.

3. Sort the list of computations by clicking the specific column header.

4. To stop a computation, click the <FaEllipsis size={25} style={{position: 'relative', top: '5px'}}/> icon in the specific list item and select the **Stop** option that appears in the popup menu.
...
### Manage user's workspaces <MajorUpdate/>

1. Find the user in your Admin panel's [user list](#view-users) and open their profile.

2. Go to the **Workspaces** tab.

3. To open one of the user's workspaces, click the <FaEllipsis size={25} style={{position: 'relative', top: '5px'}}/> icon in the specific list and select the **Open** option that appears in the popup menu.

    <Zoom src="/datalore/img/manage-users/workspace-1.png" alt="Admin panel overview" width="60%"/>
    :::tip
    The link will take you to a new browser tab. As an admin, you can manage the workspace with edit rights.
    :::

4. To create a personal workspace for the user, follow these steps:

    1. Expand the **Actions** menu at the bottom of the user's profile and select **Create workspace for user**.

    <Zoom src="/datalore/img/manage-users/workspace-2.png" alt="Admin panel overview" width="60%"/>
...
## Managing and sharing resources with viewers <MajorUpdate/>

As an administrator, you can manage and share Datalore resources with viewers. Viewers can only access notebooks and reports shared with them, without the ability to create, edit, or manage content. This means that:

- Viewers can be part of groups that include other user types, but their access remains restricted to *viewing shared content*.
- You can't share notebooks or other resources with edit rights to viewers. If you do so, Datalore will return the following error:

    <Zoom src="/datalore/img/manage-users/manage-users-12.png" alt="Admin panel overview" width="40%"/>

- The file system view for viewers is the same as that of regular users, but with restricted access.
